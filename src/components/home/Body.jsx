    ...
    <div className="mb-4 w-full flex justify-evenly">
      <div className=" flex bg-white flex-col rounded-lg border p-2 shadow-md  ">
        ...
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-xl text-gray-500">Police Department</h1>
          <Link to="/police">
      ...
      <div className=" flex bg-white flex-col rounded-lg border p-2 shadow-md">
        ...
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-xl text-gray-500">Fire Department</h1>
          <Link to="/fire">
      ...
      <div className="flex bg-white flex-col rounded-lg border p-2 shadow-md">
        ...
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-xl text-gray-500">Health Department</h1>
          <Link to="/hospital">
            <button className="text-2xl font-semibold mt-4 border-2 px-2 rounded-md text-white py-2 hover:bg-slate-900 bg-gray-800">
              <h1 className="">Select Department</h1>
            </button>
